...
<body>
  <?php $array = [
    [
      ...
      Quando cerchi un nome, potresti trovare una notifica in cui viene spiegato che i risultati potrebbero essere stati modificati nel rispetto delle leggi europee per la protezione dei dati. Mostriamo questa notifica agli utenti europei quando cercano la maggior parte dei nomi, non soltanto le pagine che sono state soggette a una rimozione.<br><br><br>"
    ],
    [
      ...
      Scopri quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali, lasciando a te il controllo.<br><br><br>"
    ],
    [
      ...
      <ol class=\"outside\">
        <li>
          <span>La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:</span>
          <ol class=\"inside\">
            <li>
      ...
      Tieni presente che i servizi Google sono fondamentalmente gli stessi a prescindere dalla società consociata che li offre o dal paese a cui è associato il tuo account.<br><br><br>"
    ],
    [
  ...
  <header>
    <div class="menu">
      <div class="images">
        <img src="Google_2015_logo.svg" alt="" class="google-logo">
  ...
  <main>
    ...
    <?php foreach($array as $info) { ?>
      ...
      <div>
        <h3><?php echo $info['question'] ?><br></h3>
        <p><br><?php echo $info['answer']; ?></p>
      </div>
